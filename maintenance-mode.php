...
@package maintenance-mode-littlebizzy
@author LittleBizzy
@version 1.0.0
*/
 ...
 class mmlMaintenance
 {
   ...
   */
   ...
   {
     add_submenu_page('options-general.php', 'Maintenance Mode', 'Maintenance Mode', 'delete_plugins', 'maintenance-mode-littlebizzy', array($this, 'settingsPage'));
   }
   ...
   */
       ...
       <div class="wrap">
           ...
           <form method="post" action="options.php">
               ...
               <table class="form-table">
                   ...
                   <tr>
                       <th>
                           <a href="<?php echo esc_url(add_query_arg('preview', 'true', bloginfo('url'))); ?>" target="_blank" class="button button-secondary"><?php echo 'Preview'; ?></a>
                       </th>
                   </tr>
               </table>
               <?php submit_button(); ?>
   ...
   {
       // enabled
       if (get_option('mml-enabled') || isset($_GET['preview']) && $_GET['preview'] == 'true') :
           return true;
       endif;
   ...
   */
   public function maintenance()
   {
      ...
      //  do_action('mml_before_mm');
       ...
       if (!(current_user_can('super admin')) || (isset($_GET['preview']) && $_GET['preview'] == 'true')) {
